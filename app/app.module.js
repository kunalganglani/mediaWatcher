System.register(['@angular/core', '@angular/platform-browser', '@angular/forms', './app.component', './media-item.component', './media-item-list.component', './media-item-form.component', './favorite.directive', './category-list.pipe', './media-item.service', './providers'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, platform_browser_1, forms_1, app_component_1, media_item_component_1, media_item_list_component_1, media_item_form_component_1, favorite_directive_1, category_list_pipe_1, media_item_service_1, providers_1;
    var AppModule;
    return {
        setters:[
            function (core_1_1) {
